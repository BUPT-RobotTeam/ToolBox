...
public:
    ...
    Q_INVOKABLE void setTxProtocolState(bool txpState);
    Q_INVOKABLE bool getTxProtocolState();
    Q_INVOKABLE void setRxProtocolState(bool rxpState);
    Q_INVOKABLE bool getRxProtocolState();
...
private slots:
    ...
    void packetReceivedNoProtocol(QByteArray &data);
...
private:
    ...
    bool mRxProtocolState;
    bool mTxProtocolState;
