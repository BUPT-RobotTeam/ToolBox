...
#endif
              "Author:<br>"
              "       BuptRobot2019 ZohyCao<br>"
              "       BuptRobot2019 Cherish<br>"
              "<Br>"
              "Based on vesc_tool 1.24<br>")
        .
...
QString Utility::uuid2Str(QByteArray uuid, bool space)
{
    ...
    {
        QString str = QString::number(uuid.at(i), 16).rightJustified(2, '0').toUpper();
