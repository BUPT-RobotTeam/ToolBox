...
private slots:
    ...
    void on_newDataFile_clicked();

    void on_loadDataButton_clicked();

    void on_cmdBrowserClearButton_clicked();

    void on_cmdBrowser_textChanged();
...
private:
    ...
    bool loadDataFile(QString file);
    void appendDoubleAndTrunc(QVector<double> *vec, double num, int maxSize);
    void addChannalPlots(QVector<double> xAxis);
    void updateZoom();
